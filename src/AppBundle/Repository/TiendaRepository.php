...
class TiendaRepository extends EntityRepository
{
    public function findUltimasOfertasPublicadas($tienda_id, $limite = 10)
    {
        ...
        $consulta = $em->createQuery(' SELECT o, t FROM AppBundle:Oferta o JOIN o.tienda t WHERE o.revisada = true AND o.fechaPublicacion < :fecha AND o.tienda = :id ORDER BY o.fechaExpiracion DESC');
    ...
    {
        $em = $this->getEntityManager();
        $consulta = $em->createQuery(' SELECT t, c FROM AppBundle:Tienda t JOIN t.ciudad c WHERE c.slug = :ciudad AND t.slug != :tienda');
